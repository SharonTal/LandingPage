    ...
    <div className="about-section-container">
      ...
      <div className="about-section-text-container">
        ...
        <p className="primary-text">
          STEP 1: Import Our Library - Seamlessly integrate our technology with a few lines of code.
        </p>
        <p className="primary-text">
          STEP 2: Set Your Camouflage - Let your user Choose from a wide range of innocent-looking themes like calculators, calendars, weather apps, and more.
        </p>
        <p className="primary-text">
          STEP 3: Unlock Secretly - Only those with the secret can reveal and access the real application beneath the facade.
        </p>
